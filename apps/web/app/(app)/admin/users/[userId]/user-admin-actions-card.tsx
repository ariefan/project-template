...
export function UserAdminActionsCard({
  ...
  const {
    ...
    queryFn: async () => {
      // @ts-expect-error - Better Auth admin.listUserSessions exists at runtime
  ...
  const banMutation = useMutation({
    mutationFn: async () => {
      ...
      // @ts-expect-error - Better Auth admin.banUser exists at runtime
  ...
  const unbanMutation = useMutation({
    mutationFn: async () => {
      // @ts-expect-error - Better Auth admin.unbanUser exists at runtime
  ...
  const setPasswordMutation = useMutation({
    mutationFn: async () => {
      ...
      // @ts-expect-error - Better Auth admin.setUserPassword exists at runtime
  ...
  const revokeSessionMutation = useMutation({
    mutationFn: async (sessionToken: string) => {
      // @ts-expect-error - Better Auth admin.revokeUserSession exists at runtime
  ...
  const revokeAllSessionsMutation = useMutation({
    mutationFn: async () => {
      // @ts-expect-error - Better Auth admin.revokeUserSessions exists at runtime
  ...
  const deleteMutation = useMutation({
    mutationFn: async () => {
      // @ts-expect-error - Better Auth admin.removeUser exists at runtime
