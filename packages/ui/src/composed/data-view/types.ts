...
export interface FieldDef<T = unknown> {
  ...
  badgeVariants?: Record<string, "default" | "secondary" | "destructive" | "outline" | "success" | "warning">
...
export interface DataViewConfig<T = unknown> {
  ...
  listItemRenderer?: (props: { row: T; fields: FieldDef<T>[]; selected: boolean; onSelect: () => void }) => React.ReactNode
  /** Custom grid card renderer */
  gridCardRenderer?: (props: { row: T; fields: FieldDef<T>[]; selected: boolean; onSelect: () => void }) => React.ReactNode
