 ...
 */
export const zLegalDocumentStatus = z.enum(["draft", "published", "archived"]);
...
export const zNotificationPreferences = z.object({
  ...
  preferredEmail: z.optional(z.union([z.string(), z.null()])),
  preferredPhone: z.optional(z.union([z.string(), z.null()])),
  preferredTelegramId: z.optional(z.union([z.string(), z.null()])),
  quietHoursEnabled: z.boolean(),
  quietHoursStart: z.optional(z.union([z.string(), z.null()])),
  quietHoursEnd: z.optional(z.union([z.string(), z.null()])),
  quietHoursTimezone: z.optional(z.union([z.string(), z.null()])),
  createdAt: z.iso.datetime(),
  updatedAt: z.iso.datetime(),
});
 ...
 * The request has succeeded.
 */
export const zJobsCreateResponse = z.union([zJobResponse, zErrorResponse]);
