 ...
 */
export const zJobTypeInfo = z.object({
    type: z.string(),
    label: z.string(),
    description: z.string(),
    configSchema: z.optional(z.string()),
    exampleConfig: z.optional(z.record(z.string(), z.unknown()))
});
 ...
 */
export const zJobTypesListResponse = z.object({
    data: z.array(zJobTypeInfo),
    meta: zResponseMeta
});
...
export const zJobTypesListData = z.object({
    body: z.optional(z.never()),
    path: z.optional(z.never()),
    query: z.optional(z.never())
});
 ...
 * The request has succeeded.
 */
export const zJobTypesListResponse2 = z.union([
    zJobTypesListResponse,
    zErrorResponse
]);
