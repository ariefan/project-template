...
export const jobTypesListQueryKey = (options?: Options<JobTypesListData>) => createQueryKey('jobTypesList', options);
 ...
 */
export const jobTypesListOptions = (options?: Options<JobTypesListData>) => queryOptions<JobTypesListResponse2, DefaultError, JobTypesListResponse2, ReturnType<typeof jobTypesListQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: jobTypesListQueryKey(options)
});
 ...
 */
export const backupsListOptions = (options: Options<BackupsListData>) => queryOptions<BackupsListResponse, DefaultError, BackupsListResponse, ReturnType<typeof backupsListQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
...
export const backupsListInfiniteQueryKey = (options: Options<BackupsListData>): QueryKey<Options<BackupsListData>> => createQueryKey('backupsList', options, true);
 ...
 * Returns paginated list of backups for the organization.
 */
export const backupsListInfiniteOptions = (options: Options<BackupsListData>) => infiniteQueryOptions<BackupsListResponse, DefaultError, InfiniteData<BackupsListResponse>, QueryKey<Options<BackupsListData>>, number | Pick<QueryKey<Options<BackupsListData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
// @ts-ignore
{
    queryFn: async ({ pageParam, queryKey, signal }) => {
        // @ts-ignore
        const page: Pick<QueryKey<Options<BackupsListData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
            query: {
                page: pageParam
            }
        };
    ...
    queryKey: backupsListInfiniteQueryKey(options)
});
 ...
 */
export const backupsCreateMutation = (options?: Partial<Options<BackupsCreateData>>): UseMutationOptions<BackupsCreateResponse, DefaultError, Options<BackupsCreateData>> => {
    const mutationOptions: UseMutationOptions<BackupsCreateResponse, DefaultError, Options<BackupsCreateData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await backupsCreate({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 * Delete a backup
 */
export const backupsDeleteMutation = (options?: Partial<Options<BackupsDeleteData>>): UseMutationOptions<BackupsDeleteResponse, DefaultError, Options<BackupsDeleteData>> => {
    const mutationOptions: UseMutationOptions<BackupsDeleteResponse, DefaultError, Options<BackupsDeleteData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await backupsDelete({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 * Get backup details
 */
export const backupsGetOptions = (options: Options<BackupsGetData>) => queryOptions<BackupsGetResponse, DefaultError, BackupsGetResponse, ReturnType<typeof backupsGetQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
...
export const backupsDownloadQueryKey = (options: Options<BackupsDownloadData>) => createQueryKey('backupsDownload', options);
 ...
 */
export const backupsDownloadOptions = (options: Options<BackupsDownloadData>) => queryOptions<BackupsDownloadResponse, DefaultError, BackupsDownloadResponse, ReturnType<typeof backupsDownloadQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await backupsDownload({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: backupsDownloadQueryKey(options)
});
 ...
 */
export const backupsRestoreMutation = (options?: Partial<Options<BackupsRestoreData>>): UseMutationOptions<BackupsRestoreResponse, DefaultError, Options<BackupsRestoreData>> => {
    const mutationOptions: UseMutationOptions<BackupsRestoreResponse, DefaultError, Options<BackupsRestoreData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await backupsRestore({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const systemOrganizationsListQueryKey = (options?: Options<SystemOrganizationsListData>) => createQueryKey('systemOrganizationsList', options);

/**
 * List all system organizations (Admin only)
 */
export const systemOrganizationsListOptions = (options?: Options<SystemOrganizationsListData>) => queryOptions<SystemOrganizationsListResponse, DefaultError, SystemOrganizationsListResponse, ReturnType<typeof systemOrganizationsListQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
...
export const systemOrganizationsListInfiniteQueryKey = (options?: Options<SystemOrganizationsListData>): QueryKey<Options<SystemOrganizationsListData>> => createQueryKey('systemOrganizationsList', options, true);

/**
 * List all system organizations (Admin only)
 */
export const systemOrganizationsListInfiniteOptions = (options?: Options<SystemOrganizationsListData>) => infiniteQueryOptions<SystemOrganizationsListResponse, DefaultError, InfiniteData<SystemOrganizationsListResponse>, QueryKey<Options<SystemOrganizationsListData>>, number | Pick<QueryKey<Options<SystemOrganizationsListData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
// @ts-ignore
{
    queryFn: async ({ pageParam, queryKey, signal }) => {
        // @ts-ignore
        const page: Pick<QueryKey<Options<SystemOrganizationsListData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
            query: {
                page: pageParam
            }
        };
 ...
 */
export const systemOrganizationsDeleteMutation = (options?: Partial<Options<SystemOrganizationsDeleteData>>): UseMutationOptions<SystemOrganizationsDeleteResponse, DefaultError, Options<SystemOrganizationsDeleteData>> => {
    const mutationOptions: UseMutationOptions<SystemOrganizationsDeleteResponse, DefaultError, Options<SystemOrganizationsDeleteData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const systemOrganizationsUpdateMutation = (options?: Partial<Options<SystemOrganizationsUpdateData>>): UseMutationOptions<SystemOrganizationsUpdateResponse, DefaultError, Options<SystemOrganizationsUpdateData>> => {
    const mutationOptions: UseMutationOptions<SystemOrganizationsUpdateResponse, DefaultError, Options<SystemOrganizationsUpdateData>> = {
        mutationFn: async (fnOptions) => {
